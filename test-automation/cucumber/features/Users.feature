Feature: Users tests
  ...
  Scenario: I can't create user with empty first name
    When I'm creating user "username" with email "mail@example.com", firstName "" lastName "Doe" jobTitle "title" password "password" and groups ""
    Then I should get response with code '400'

  Scenario: I can't create user with empty first name
    When I'm creating user "username" with email "mail@example.com", firstName "John" lastName "" jobTitle "title" password "password" and groups ""
    Then I should get response with code '400'
